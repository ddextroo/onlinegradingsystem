...
public class RequestActivity extends  AppCompatActivity  { 
	...
	private void initializeLogic() {
		...
		linear3.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b) { this.setCornerRadius(a); this.setColor(b); return this; } }.getIns((int)20, 0xFF6DD5FA));
